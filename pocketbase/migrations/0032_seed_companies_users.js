migrate(
  (app) => {
    ...
    app.runInTransaction(function (txApp) {
      var aeCol = txApp.findCollectionByNameOrId('account_executives')
      var aeData = [
        {
      ...
      var clientsCol = txApp.findCollectionByNameOrId('clients')
      var clientData = [
        {
      ...
      var agentsCol = txApp.findCollectionByNameOrId('agents')
      var agentData = [
        {
