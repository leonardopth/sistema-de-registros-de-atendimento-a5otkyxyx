migrate(
  (app) => {
    ...
    try {
      ...
      console.log('0046: error fetching users: ' + e.message)
      return
    }
    ...
    for (var j = 0; j < allUsers.length; j++) {
      ...
      try {
        ...
        console.log('0046: failed to save user ' + user.id + ': ' + err.message)
      }
    }

    console.log(
      '0046_backfill: updated=' + updated + ' skipped=' + skipped + ' total=' + allUsers.length,
    )
  },
  (app) => {},
)
