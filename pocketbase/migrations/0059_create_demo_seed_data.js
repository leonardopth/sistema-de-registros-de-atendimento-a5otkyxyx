    ...
    var userData = [
      {
        ...
        email: 'marcelo.ribeiro@rexturadvance.com.br',
        role: 'Gerente',
      ...
      },
      {
        ...
        email: 'ana.costa@rexturadvance.com.br',
        role: 'Gerente',
        approval_status: 'Aprovado',
        bases: ['RJ/ES/MG'],
      },
      {
        ...
        email: 'juliana.freitas@rexturadvance.com.br',
        role: 'Supervisor',
        approval_status: 'Aprovado',
        bases: ['NO/NE', 'CO'],
      },
      {
        name: 'Ricardo Nunes',
        email: 'ricardo.nunes@rexturadvance.com.br',
        role: 'Supervisor',
        approval_status: 'Aprovado',
        bases: ['SUL'],
      },
      {
        name: 'Gustavo Pinto',
        email: 'gustavo.pinto@rexturadvance.com.br',
        role: 'Líder',
        approval_status: 'Aprovado',
        bases: ['LOT'],
      },
      {
        ...
        email: 'camila.ferreira@rexturadvance.com.br',
        role: 'Líder',
        approval_status: 'Aprovado',
        bases: ['INSIDE SALES'],
      },
      {
        name: 'Bruno Carvalho',
        email: 'bruno.carvalho@rexturadvance.com.br',
        role: 'Consultor',
        approval_status: 'Aprovado',
        bases: ['SAO'],
      },
      {
        ...
        email: 'daniela.martins@rexturadvance.com.br',
        role: 'Consultor',
        approval_status: 'Aprovado',
        bases: ['RJ/ES/MG'],
      },
      {
        name: 'Eduardo Gomes',
        email: 'eduardo.gomes@rexturadvance.com.br',
        role: 'Consultor',
        approval_status: 'Aprovado',
        bases: ['NO/NE'],
      },
      {
        name: 'Mariana Souza',
        email: 'mariana.souza@rexturadvance.com.br',
        role: 'Consultor',
        approval_status: 'Aprovado',
        bases: ['SUL'],
      },
